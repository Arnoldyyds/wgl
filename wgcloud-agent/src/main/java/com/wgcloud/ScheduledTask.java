...
public class ScheduledTask {
    ...
    @Autowired
    private Pcap4j pcap4j; //通过对Pcap4j进行Spring托管之后，直接完成了实例化，字段注入之后直接调用就行
    ...
    public ScheduledTask() throws PcapNativeException {
    }
    ...
    public void minTask() {
        ...
        try {
            ...
            this.pcap4j.uploadPcapFile(this.pcap4j.saveCaptureToFile());
