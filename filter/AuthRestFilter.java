...
public class AuthRestFilter implements Filter {
    ...
    String[] static_resource = {"/agent/minTask", "/login/toLogin", "/login/login", "/appInfo/agentList", "/static/","/agent/uploadPcap","/alarm/","/alarm/list","/alarm/detail","/alarm/delete","/alarm/export","/alarm/blacklist/add"}; //filter允许的路径
